...
export class TestnetERC20 extends ethereum.SmartContract {
  static bind(address: Address): TestnetERC20 {
    return new TestnetERC20("TestnetERC20", address);
  }
  ...
  try_mint1(value: BigInt): ethereum.CallResult<boolean> {
